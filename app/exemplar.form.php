...
?>
    ...
    <form method='get'>
        ...
        <input type='text' name='nome_tradutor' value='<?php echo $nome_tradutor?>' class='inputx' readonly/>
        ...
        <input type='text' name='nome_editora' value='<?php echo $nome_editora?>' class='inputx' readonly/>
