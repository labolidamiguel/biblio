...
Arch::initController("@");
    ...
    if ( strlen($senha_old)>0 && strlen($senha_new1)>0  ) {
        ...
        if ($senha_new1 != $senha_new2) {
            $msg = "A senha nova deve ser igual a redigitacao da senha nova.";
        }else{
            $msg = "Trocando a senha...";
...
?>
    ...
    <i><font color="#990000"><?php echo $msg; ?></font></i>
